...
function addCreateButton(dropDown) {
    ...
    const href = "http://localhost:8000/room.html?room=" + encodeURIComponent(roomName);
    ...
    fetch("http://localhost:8000/open-rooms")
        ...
        .then(data => {
            ...
            rooms.forEach(element => {
                ...
                if (!element.started) {
                    const href = "http://localhost:8000/room.html?room=" + encodeURIComponent(element.room);
